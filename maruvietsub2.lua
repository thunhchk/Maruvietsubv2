...
_G.imageLogo = "rbxassetid://92722314324124"
_G.Logo = "rbxassetid://92722314324124"
_G.NameHub = "by thịnh-hoàng" -- ชื่อ Hub
...
ImageButton.Image = "rbxassetid://92722314324124"
	...
	coroutine.resume(
		coroutine.create(
			function()
				...
				Circle.ZIndex = 10
				Circle.Image = "rbxassetid://92722314324124"
...
Disc_Logo.Image = "http://www.roblox.com/asset/?id=92722314324124"
	   ...
	   Sep2.TextXAlignment = Enum.TextXAlignment.Center
		...
		function functionitem:Button(Name, callback)
			...
			function functionitem:Toggle(Name, default, callback)
				...
				MainToggle_3.Image = "http://www.roblox.com/asset/?id=92722314324124"
			...
			function functionitem:Dropdown(Name, list, default, callback)
				...
				ImageButton.Image = "http://www.roblox.com/asset/?id=92722314324124"
...
_G.SelectWeapon = "Melee"
  AutoFarm:Dropdown("Select Weapons",{"Melee","Sword","Gun","Blox Fruit"},{"Melee"},function(v)
   ...
   AutoFarm:Toggle("cày Level",false,function(value)
    _G.AutoFarm = value
  ...
  AutoFarm:Toggle("đánh quái gần", false,function(value)
         _G.AutoNear = value
...
spawn(function()
 ...
 ---------------------------- Auto Settings 
    ...
    Settings:Toggle("gom quái", false,function(value)
    ...
    while wait() do
     ...
     FM = Trailers:Label("Full Moon")
        ...
        task.spawn(function()
            while task.wait() do
                pcall(function()
                    if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=92722314324124" then
                        FM:Set("Full Moon: 100")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=92722314324124" then
                        FM:Set("Full Moon: 75")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=92722314324124" then
                        FM:Set("Full Moon: 50")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=92722314324124" then
    ...
    ["embeds"] = {
        {
            ...
            ["fields"] = {
                ...
                },
                {
                    ...
                    ["value"] = "Đã Dùng Script Của thịnh roblox hack✅",
                    ["inline"] = false
                }
            }
        }
...
game:GetService("StarterGui"):SetCore(
    "SendNotification",
    {
        Title = "MARU HUB by thịnh😒",
        Text = "Đã Tải Xong",
        Icon = "rbxthumb://type=Asset&id=92722314324124&w=150&h=150",
        Duration = 5
    }
)